namespace ComputeShaderUtility
{
	...
	public static class ComputeHelper
	{
		...
		public static Vector2Int[] GenerateRings(int innerRing, int outterRing){


			List<Vector2Int> offsetsOut = new List<Vector2Int>();
			...
			while (y <= x)
			{
				offsetsOut.Add(new Vector2Int( x,  y));
				offsetsOut.Add(new Vector2Int( y,  x));
				offsetsOut.Add(new Vector2Int(-x,  y));
				offsetsOut.Add(new Vector2Int(-y,  x));
				offsetsOut.Add(new Vector2Int(-x, -y));
				offsetsOut.Add(new Vector2Int(-y, -x));
			...
			List<Vector2Int> offsetsIn = new List<Vector2Int>();
			...
			while (y <= x)
			{
				offsetsIn.Add(new Vector2Int( x,  y));
				offsetsIn.Add(new Vector2Int( y,  x));
				offsetsIn.Add(new Vector2Int(-x,  y));
				offsetsIn.Add(new Vector2Int(-y,  x));
				offsetsIn.Add(new Vector2Int(-x, -y));
				offsetsIn.Add(new Vector2Int(-y, -x));
			...
			List<Vector2Int> difference= new List<Vector2Int>();

			difference=GetDifference(offsetsOut, offsetsIn);



			Vector2Int[] offsets = new Vector2Int[0];
			offsets=listToArray(difference);

			return offsets;
		}
		static List<Vector2Int> GetDifference(List<Vector2Int> a, List<Vector2Int> b){
		...
		static Vector2Int[] listToArray(List<Vector2Int> list){
		...
		public static Vector2Int[] GenerateGrid(int size)
    	{
        // Create an array to hold the offsets
			Vector2Int[] offsets = new Vector2Int[(size*2+1)*(size*2+1)];
